  ...
  return (
    <header className="header-bar">
      ...
      <nav className="nav-links">
        ...
        {location.pathname !== "/" && location.pathname !== "/dungeons" && (
          <Link to="/dungeons" className="cta-btn dark">Dungeons</Link>
        )}
      </nav>
      <div>
        {!isLoggedIn ? (
          <button onClick={() => handleDiscordLogin()} className="discord-login">
